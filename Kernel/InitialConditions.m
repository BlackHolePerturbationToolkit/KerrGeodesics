...
KerrGeoInit2pex[a_,{t0_,r0_,\[Theta]0_,\[Phi]0_},u_List,{En_:Null,L_:Null,Q_:Null}]:=Module[{rts,disc,r1,r2,zm},
	If[MemberQ[{En,L,Q},Null],{En,L,Q}=(Values@KerrGeoInit2Constants[a,{t0,r0,\[Theta]0,\[Phi]0},u])];
	Print[{En,L,Q}];
	disc=RDisc[a,En,L,Q];
	...
	Which[
		Q<0, Print["Vortical (polar-cone) orbit detected"],
		disc<0, Print["Plunge orbit detected"],
		True, r1=If[En<1,rts[[4]],rts[[1]]]; r2=If[En<1,rts[[3]],rts[[4]]];
	];
	<|"p"->(2 r1 r2)/(r1+r2),"e"->(r1-r2)/(r1+r2),"x"->Sign[L] Sqrt[1-zm]|>
]


KerrGeoInit2Phases[a_,{t0_,r0_,\[Theta]0_,\[Phi]0_},u_List,{En_:Null,L_:Null,Q_:Null},{p_:Null,e_:Null,x_:Null}] := Module[{zm,zp,mr,\[Lambda]r0,m\[Theta],\[Lambda]\[Theta]0,\[CapitalUpsilon]r,\[CapitalUpsilon]\[Theta],\[CapitalUpsilon]\[Phi],\[CapitalUpsilon]t,r1,r2,r3,r4,qr0,q\[Theta]0,\[Psi]r0,\[Psi]\[Theta]0},
	If[MemberQ[{En,L,Q},Null],{En,L,Q}=(Values@KerrGeoInit2Constants[a,{t0,r0,\[Theta]0,\[Phi]0},u])];
	If[MemberQ[{p,e,x},Null],{p,e,x} = (Values@KerrGeoInit2pex[a,{t0,r0,\[Theta]0,\[Phi]0},u,{En,L,Q}])];
...
KerrGeoInitOrbit[a_,{t0_,r0_,\[Theta]0_,\[Phi]0_},u_List,{En_:Null,L_:Null,Q_:Null},{p_:Null,e_:Null,x_:Null}] := Module[{initPhases},
