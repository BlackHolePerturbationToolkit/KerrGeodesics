...
KerrGeoOrbitType[a_?NumericQ, p_?NumericQ, e_?NumericQ, x_?NumericQ]:=
	If[KerrGeoBoundOrbitQ[a,p,e,x] == True, "Bound",
		If[KerrGeoScatterOrbitQ[a,p,e,x] == True, "Scatter", "Plunge"]]
